                ...
                <tbody>
                        ...
                        @foreach($order->orderItem as $item)
                            ...
                            @php
                                ...
                                $note = App\Models\OrderProductNote::where('order_id',$item->order_id)->where('product_id',$item->product_id)->orderBy('id','desc')->first();
                           ...
                           @csrf
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>${{$total + (int)$order->shipping_price}}</td>
