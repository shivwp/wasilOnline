                                      ...
                                      <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                       ...
                                                       <label class="form-label">Coupon amount type</label>
                                                        ...
                                                        <select class="form-control select2" name="amount_type" id="coupon_amount" >
                                                        <option value="exclude"disabled>Select</option>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <label class="form-label">Minimum Order Limit</label>

                                                        <input type="number" class="form-control" name="maximum_spend" placeholder="Minimum" value="{{isset($coupon) ? $coupon->maximum_spend : '' }}" required>

                                                    </div>
                                                    <div class="form-group">

                                                        <label class="form-label">Maximum times use the coupon</label>
                                              ...
                                              <!--       <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="minimum_spend" placeholder="Maximum" value="{{isset($coupon) ? $coupon->minimum_spend : '' }}" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="limit_per_user" placeholder="Limit" value="{{isset($coupon) ? $coupon->limit_per_user : '' }}" required>
