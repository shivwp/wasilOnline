                                             ...
                                             <form method="get" class="page-number"  >
                                                ...
                                                <form>
                                                  ...
                                                  <button type="submit" class="form-control src-btn" ><i class="angle fe fe-search"></i></button>
                                                   <a class="form-control src-btn" href="{{ route('dashboard.card-deatils') }}"><i class="angle fe fe-rotate-ccw"></i></a>
                                              </div>
                                          </form> 
                                               </div>
                                            <table id="" class="table table-striped table-bordered text-nowrap w-100">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-15p">Card Name</th>
                                                        <th class="wd-15p"> Total Amount</th>
                                                        <th class="wd-15p"> Used Amount</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                @if(count($giftcards)>0)
                                                    @foreach($giftcards as $key => $item)
                                                    <tr>
                                                    <td>{{$item->id ?? '' }}</td>
