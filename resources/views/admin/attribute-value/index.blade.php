...
@section('page-header')
                        <!-- PAGE-HEADER -->
                            <div>
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Attribute Value</a></li>
...
@section('content')
                        <!-- ROW-1 OPEN-->
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <a href="{{ route('dashboard.attribute-value.create') }}" class="btn btn-info-light ">
                                    {{$buton_name}}
                                </a>
                            </div>
                                    <div class="card-body">
                                            ...
                                            <table id="" class="table table-striped table-bordered text-nowrap w-100">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-15p">Attribute Values</th>
                                                ...
                                                @if(count($attributeVal)>0)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                                ...
                                                                <form action="{{ route('dashboard.attribute-value.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure');" style="display: inline-block;">
                                                                        <input type="hidden" name="_method" value="DELETE">
                                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                                        <button type="submit" class="btn btn-sm btn-danger" value="{{ trans('global.delete') }}"><i class="fa fa-trash"></i></button>
                                                                </form>
                                                                {{--<a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Add attribute value" href="{{ route('dashboard.attribute.edit', $item->id) }}"><i class="fa fa-plus"></i> </a>--}}  
                                        ...
                                        <div id="pagination">{{{ $attributeVal->links() }}}</div>
                                    </div>
                                    <!-- TABLE WRAPPER -->
                                </div>
                                <!-- SECTION WRAPPER -->
