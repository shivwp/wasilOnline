                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                               ...
                                               <form>
                                                  ...
                                                  {{-- <div class="search_bar d-flex">  
                                                    ...
                                                    <input type="" class="form-control" id="search" name="search" value="{{ (request()->get('search') != null) ? request()->get('search') : ''}}" placeholder="Search"></input>
                                                        ...
                                                        <button button type="submit" class="form-control src-btn" ><i class="angle fe fe-search"></i></button>
                                            ...
                                            <table id="" class="table table-striped table-bordered text-nowrap w-100">
                                                ...
                                                @if(count($UserWalletTransection)>0)

                                                    @foreach($UserWalletTransection as $key => $item)
                                        ...
                                        <div id="pagination">{{{ $UserWalletTransection->links() }}}</div>
