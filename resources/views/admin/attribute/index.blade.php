                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <a href="{{ route('dashboard.attribute.create') }}" class="btn btn-info-light ">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <form method="get" class="page-number"  >
                                                ...
                                                <form>
                                                  ...
                                                  <button type="submit" class="form-control src-btn" ><i class="angle fe fe-search"></i></button>
                                                   <a class="form-control src-btn" href="{{ route('dashboard.attribute.index') }}"><i class="angle fe fe-rotate-ccw"></i></a>
                                              </div>
                                          </form> 
                                               </div>
                                                ...
                                                @if(count($attribute)>0)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                                 ...
                                                                 <a class="btn btn-sm btn-success" href="{{ route('dashboard.attr-value',$item->id) }}">view value</a>
                                        ...
                                        <div id="pagination">{{{ $attribute->links() }}}</div>
                                    </div>
